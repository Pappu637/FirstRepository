...
public class CompleteFlow {
	...
	public static String adult = "(//a[@ng-click='AdultIncrement(4);'])[1]";
	public static String child = "(//a[@ng-click='ChildIncrement(2);'])[1]";
	public static String infant = "(//a[@ng-click='InfantIncrement(1);'])[1]";
